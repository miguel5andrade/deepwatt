...
def push_budget_message():
    ...
    client = mqtt.Client(client_id="deepwatt_subscriber33", protocol=mqtt.MQTTv5, callback_api_version=mqtt.CallbackAPIVersion.VERSION2)
    ...
    for record in budgets:
        print(record.monitoring_device_id)
